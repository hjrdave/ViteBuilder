  ...
  return (
    <>
      <Card>
        ...
        <Card.Body>
          <Card.Title className={'text-primary fs-2'}>{title}</Card.Title>
          <div className={'d-flex align-items-center pt-3'}>
            {startingAt ? (
              <>
                <Card.Subtitle className='pe-3 mb-2 text-muted'>Starting at:</Card.Subtitle>
        ...
        <Card.Footer className={'d-flex justify-content-center pb-4'}>
          {onSelect ? (
            <Button variant='secondary' className={'w-75'} onClick={onSelect}>
              Select
            </Button>
          ) : null}
        </Card.Footer>
