...
Primary.args = {
    ...
    includes: [
        {
            text: <><strong>150%</strong> trip interruption coverage</>
        },
        {
            text: <>Medical expense coverage, including Covid treatment, up to <strong>$500,000</strong></>
        },
        {
            text: <>Trip delay coverage up to <strong>$2,000</strong></>
        },
        {
